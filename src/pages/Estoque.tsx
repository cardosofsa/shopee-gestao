...
import { PosicaoTab } from './estoque/PosicaoTab';
import type { EstoqueItem } from './estoque/PosicaoTab';
import { ComprasTab } from './estoque/ComprasTab';
import { MovimentacoesTab } from './estoque/MovimentacoesTab';
...
function AddCompraModal({ onClose }: { onClose: () => void }) {
  ...
  const [cab, setCab] = useState({
    ...
    loja: 'Cardoso e-Shop', observacoes: '',
  });
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="flex items-center gap-3 bg-slate-50 dark:bg-slate-700/50 rounded-xl p-3">
            <input type="checkbox" id="ativo" checked={form.ativo} onChange={f('ativo')}
              className="w-4 h-4 accent-shopee-500" />
