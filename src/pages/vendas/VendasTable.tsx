...
function SortIcon({ col, sortCol, sortDir }: {
  ...
  return sortDir === 'asc'
    ? <ArrowUp   size={11} className="ml-1 text-shopee-500 flex-shrink-0" />
    : <ArrowDown size={11} className="ml-1 text-shopee-500 flex-shrink-0" />;
}
            ...
            return (
              <button key={s}
                ...
                className={`w-full text-left px-3 py-2.5 text-xs font-medium flex items-center gap-2.5 transition-colors hover:bg-slate-50 dark:hover:bg-slate-700 ${
                  isCur
                    ? 'text-shopee-600 bg-shopee-50/50 dark:bg-shopee-900/20 dark:text-shopee-300'
                    : 'text-slate-700 dark:text-slate-300'
                }`}
              >
                <span className={`w-2 h-2 rounded-full flex-shrink-0 ${STATUS_STYLE[s].dot}`} />
                {s}
                {isCur && <Check size={11} className="ml-auto text-shopee-500" />}
              </button>
            );
          })}
        </div>
            ...
            <tr>
              <th className="px-3 py-3 w-8">
                <button onClick={onToggleSelectAll}
                  className="text-slate-400 hover:text-shopee-500 transition-colors">
                  {allSelected
                    ? <CheckSquare size={15} className="text-shopee-500" />
                    : <Square size={15} />}
                </button>
              </th>
                      ...
                      <tr
                        ...
                        className={`transition-colors cursor-pointer select-none ${
                          selectedIds.has(p.id)
                            ? 'bg-shopee-50 dark:bg-shopee-900/20 hover:bg-shopee-50 dark:hover:bg-shopee-900/20'
                            : isExpanded
                      ...
                      >
                        <td className="px-3 py-2.5">
                          <button
                            ...
                            className="text-slate-300 hover:text-shopee-500 transition-colors"
                          >
                            {selectedIds.has(p.id)
                              ? <CheckSquare size={15} className="text-shopee-500" />
                              : <Square size={15} />}
