...
const Sazonalidade    = lazy(() => import('./pages/Sazonalidade'));
...
const Ads             = lazy(() => import('./modules/marketing/pages/Ads'));
  ...
  return (
    <Routes>
      <Route path="/" element={<Layout />}>
        ...
        <Route path="dre"           element={page(DRE,              'DRE')}           />
        <Route path="comparativo"   element={page(Comparativo,      'Comparativo')}   />
        ...
        <Route path="sazonalidade"  element={page(Sazonalidade,'Sazonalidade')}     />
        ...
        <Route path="ads"           element={page(Ads,         'ACOS / Ads')}       />
        ...
        <Route path="compras"       element={page(Compras,     'Compras')}          />
        <Route path="hoje"          element={page(Hoje,        'Hoje')}             />
        <Route path="analise"       element={page(Analise,     'Análise')}          />
        <Route path="previsao"      element={page(Previsao,    'Previsão')}         />
        <Route path="abc"           element={page(CurvaABC,    'Curva ABC')}        />
